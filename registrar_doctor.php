<?php
  ...
  if (isset($_POST['nombre'])) {
    ...
    $respuesta = $trabajadores->registrar_doctor($_POST['nombre'], $_POST['apellido'], $_POST['cedula'], $_POST['correo'], $_POST['celular'], $_POST['telefono'], $_POST['sexo'], $_POST['edad'], $_POST['turno'], $_POST['especialidad'], $_POST['direccion']);

    if ($respuesta == 1) {
      header('Location: inicio.php?registro=1');
    }
  }
...
<body>
  ...
  <div class="container col-md-8 center-block formulario">
    ...
    <form action="registrar_doctor.php" id="registrar_doctor" method="POST">
      <div class="form-row">
      ...
      <div class="form-row">
        ...
        <div class="form-group col-md-4">
          <label>Celular</label>
          <input type="number" class="form-control" id="celular" onkeypress="return validNumeros(event, this)" name="celular" placeholder="04121234567" maxlength="11">
        </div>
        <div class="form-group col-md-4">
          <label for="inputPassword4">Teléfono</label>
          <input type="number" class="form-control" id="telefono" onkeypress="return validNumeros(event, this)" name="telefono" placeholder="02431234567" maxlength="11">
        </div>
      </div>
      <div class="form-row">
        <div class="form-group col-md-4">
        ...
        <div class="form-group col-md-4">
          <label for="inputPassword4">Turno de Trabajo</label>
      ...
      <div class="form-row">
        <div class="form-group col-md-4">
          ...
          <input type="text" class="form-control" id="especialidad" name="especialidad" placeholder="Oftalmologia">
        </div>
    ...
    <button type="button" class="btn btn-primary btn-block" onclick="confirmar();">Registrar Doctor</button>
    </form>
  </div>
  ...
  <script type="text/javascript">
    ...
    function confirmar() {
      ...
      if ($("#nombre").val() == "" || $("#apellido").val() == "" || $("#cedula").val() == "" || $("#correo").val() == "" || $("#celular").val() == "" || $("#telefono").val() == "" || $("#edad").val() == "" || $("#especialidad").val() == "" || $("#direccion").val() == "")
      {
        ...
        document.getElementById('registrar_doctor').submit();
      }
