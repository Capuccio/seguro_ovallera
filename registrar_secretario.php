<?php
  ...
  if (isset($_POST['nombre'])) {
    ...
    $respuesta = $trabajadores->registrar_secretario($_POST['nombre'], $_POST['apellido'], $_POST['cedula'], $_POST['correo'], $_POST['celular'], $_POST['telefono'], $_POST['sexo'], $_POST['edad'], $_POST['turno'], $_POST['direccion']);

    if ($respuesta == 1) {
      header('Location: inicio.php?registro=2');
    }
  }
...
<head>
  ...
  <title>VSS José Antonio Vargas - Registrar Secretario/a</title>
...
<body>
  ...
  <?php include 'plantillas/menu.php'; ?>
    ...
    <div class="container col-md-8 center-block formulario">
      ...
      <form action="registrar_secretario.php" id="registrar_secretario" method="POST">
        <div class="form-row">
        ...
        <div class="form-row">
          ...
          <div class="form-group col-md-4">
            ...
            <input type="number" class="form-control" id="celular" onkeypress="return validNumeros(event, this)" name="celular" placeholder="0412-1234567" maxlength="12">
          </div>
          <div class="form-group col-md-4">
            <label for="inputPassword4">Teléfono</label>
            <input type="number" class="form-control" id="telefono" onkeypress="return validNumeros(event, this)" name="telefono" placeholder="0243-1234567" maxlength="12">
          </div>
        </div>
        <div class="form-row">
          <div class="form-group col-md-4">
          ...
          <div class="form-group col-md-4">
            ...
            <input type="text" class="form-control" id="edad" name="edad" placeholder="30">
          </div>
          <div class="form-group col-md-4">
      ...
      <button type="button" class="btn btn-primary btn-block" onclick="confirmar();">Registrar Secretario/a</button>
      </form>
    </div>
    ...
    const validNumeros = (event, max) => {
      ...
      function confirmar() {
        ...
        if ($("#nombre").val() == "" || $("#apellido").val() == "" || $("#cedula").val() == "" || $("#correo").val() == "" || $("#celular").val() == "" || $("#telefono").val() == "" || $("#edad").val() == "" || $("#direccion").val() == "")
        {
          ...
          document.getElementById('registrar_secretario').submit();
        }
